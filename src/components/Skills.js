...
function Skills() {
    return ( 
        <div id="skills">
            <h2 className="heading"><FontAwesomeIcon icon={faClipboard} /> Достижения</h2>
            <ul>
                <li><FontAwesomeIcon icon={faHtml5} /> Операция вен ног</li>
                <li><FontAwesomeIcon icon={faCss3} />  Курс такой то</li>
                {/*      */}
                <li><FontAwesomeIcon icon={faPython} /> Диплом лучшего врача года 2021</li>
